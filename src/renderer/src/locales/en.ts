...
export const en = {
  ...
  browser: {
    ...
    sessionCookies: {
      ...
      active: 'Active',
      noCookiesImported: 'No cookies imported',
      importCookies: 'Import Cookies',
      fromBrowser: 'From {{browser}}',
      fromFile: 'From File…',
      importFromBrowserSuccess: 'Imported {{count}} cookies from {{browser}} into {{profile}}.',
      importFromFileSuccess: 'Imported {{count}} cookies from file into {{profile}}.',
      defaultCookiesCleared: 'Default cookies cleared.',
      profileRemoved: 'Profile "{{label}}" removed.'
    }
  },
  notifications: {
    enable: 'Enable',
  ...
  automations: {
    ...
    editor: {
      ...
      createHermesCron: 'Create Hermes cron',
      createAutomation: 'Create automation',
      namePlaceholder: 'Weekday repo audit',
      nameAriaLabel: 'Automation name',
      useTemplate: 'Use template',
      promptLabel: 'Prompt',
      promptPlaceholder: 'Run the weekly dependency audit and summarize risky changes.',
      projectLabel: 'Project',
      selectProjectPlaceholder: 'Select project',
      workspaceLabel: 'Workspace',
      startBranchLabel: 'Start branch',
      modeWorktree: 'worktree',
      modeNewRun: 'New run',
      agentLabel: 'Agent',
      scheduleLabel: 'Schedule',
      graceLabel: 'Grace',
      graceHelpAriaLabel: 'Missed-run grace help',
      graceHelpTooltip:
      ...
      projectDefault: 'Project default',
      searchRepoBranches: 'Search repo branches...',
      searchingBranches: 'Searching branches...',
      ...
      cronStringLabel: 'Cron string',
      cronStringHelp: 'Five fields: minute hour day month weekday.',
      cronStringError: 'Enter a valid 5-field cron expression.',
      dayLabel: 'Day',
      minuteLabel: 'Minute',
      timeLabel: 'Time',
      sunday: 'Sunday',
  ...
  gitlabItem: {
    ...
    toast: {
      closedMR: 'Closed MR !{{number}}',
      reopenedMR: 'Reopened MR !{{number}}',
      mergedMR: 'Merged MR !{{number}}'
    },
    dialog: {
      fallbackTitle: 'GitLab item',
      description: 'GitLab work item detail',
      byAuthor: 'by {{author}}',
      ...
      empty: {
        ...
        noPipelineRuns: 'No pipeline runs for this MR.'
      },
      commentPlaceholder: 'Comment on {{prefix}}{{number}}…',
  ...
  updatesCard: {
    ...
    reassuranceTip: "Your terminal sessions won't be interrupted during the update.",
    dismissTip: 'Dismiss tip',
    newVersion: 'New: {{title}}',
    dismissUpdate: 'Dismiss update',
    moreReleases: '+{{count}} more since your last update',
    readNotes: 'Read the full release notes',
    update: 'Update',
    availableTitle: 'Update Available',
    readyVersion: 'Orca v{{version}} is ready.',
    noInterruption: "Sessions won't be interrupted.",
    releaseNotes: 'Release notes',
    downloadingTitle: 'Downloading Update',
    minimize: 'Minimize to status bar',
    downloadingVersion: 'Orca v{{version}} is downloading.',
    downloadingProgress: 'Downloading... {{percent}}%',
    errorTitle: 'Update Error',
    checkFailedTitle: 'Update Check Failed',
    completeFailed: 'Could not complete the update.',
    checkFailed: 'Could not check for updates.',
    retryDownload: 'Retry Download',
    recheck: 'Re-check',
    tryAgain: 'Try Again',
    downloadManually: 'Download Manually',
    readyToInstallTitle: 'Ready to Install',
    downloadedRestart: "Orca v{{version}} is downloaded. Restart when you're ready.",
    restartToUpdate: 'Restart to Update',
    installing: 'Installing...'
  },
  telemetryBanner: {
    ariaLabel: 'Telemetry notice',
  ...
  starNag: {
    ...
    error: 'Could not star the repo. Make sure {{cli}} is authenticated and try again.',
    starring: 'Starring…',
  ...
  jumpPalette: {
    ...
    noResultsSubtitle: 'Try a name, branch, repo, comment, PR, page title, or URL.',
    noOtherWorktreesTitle: 'No other worktrees to switch to',
    noOtherWorktreesSubtitle: 'Type to search or create a new worktree.',
    noActiveTitle: 'No active worktrees or browser tabs',
    noActiveSubtitle: 'Create a worktree or open a page in Orca to get started.',
    title: 'Jump to...',
    description: 'Search worktrees and browser tabs',
    inputPlaceholder: 'Jump to worktree or browser tab…  try "repo/worktree"',
    loadingTitle: 'Loading jump targets',
    loadingSubtitle: 'Gathering your recent worktrees and open browser pages.',
    headerWorktrees: 'Worktrees',
    headerRecentWorktrees: 'Recent Worktrees',
    worktreeCapHint: 'Type to see all {{count}} worktrees',
    headerBrowserTabs: 'Browser Tabs',
    sshDisconnected: 'SSH disconnected',
    sshRemote: 'SSH remote',
    currentBadge: 'Current',
    primaryBadge: 'primary',
    currentTabBadge: 'Current Tab',
    currentWorktreeBadge: 'Current Worktree',
    createAction: 'Create worktree "{{name}}"',
    footerOpen: 'Open',
    footerClose: 'Close',
    footerMove: 'Move',
    ariaResultsFound: '{{count}} results found',
    ariaItemsAvailable: '{{count}} items available',
    ariaCreateActionAvailable: ', create new worktree action available',
    worktreeNoLongerExists: 'Worktree no longer exists',
    browserPageNoLongerExists: 'Browser page no longer exists'
  },
  blank: 'Blank',
  '/': '/'
} as const
